/* coupon.c - Coupon Collector's Test  Version 0.1.0                 */
...
/* fails the coupon collector's test.                            */
/* The fibonacci generator is vulnerable to this test.           */
/*****************************************************************/
...
#define FIBOONE (fiboone = fibotwo)

#define FIBOTWO (fibotwo = fibonum)

#define FIBONUM (fibonum = fiboone + fibotwo)

#define FIBONACCI (FIBOONE, FIBOTWO, FIBONUM)
...
int main(int argc, char **argv)
   ...
   unsigned int fiboone;
   unsigned int fibotwo;
   unsigned int fibonum;
   double dbln;
   double modulus;
